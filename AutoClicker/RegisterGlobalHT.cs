...
namespace BattleHelper
{
    class RegisterGlobalHT
    {
        ...
        #region Setting TabContro lIndex and RadioButtons to true or falls
        ...
        internal void GetRadioButtonfromLogisticsTab(RadioButton singleLeftRbt, RadioButton singleRightRbt)
        {
        ...
        private void PickedStartAction()
        {
            switch (tabIndex)
            {
                ...
                case 2:
                    ...
                    {
                        start = true;
                        SingleRightWithLoop();              // comes from region below
                    }
                    break;
                    //case 1:
                    //case 3:
        ...
        private async void SingleRightWithLoop()
        {
            int i = 0;
            while (start == true && i < clickRepetitions)
            {
